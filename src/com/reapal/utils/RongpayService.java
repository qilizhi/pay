...
public class RongpayService {
	// private static String gateway = "http://testapi.reapal.comc";
	private static String gateway = ReapalH5Config.rongpay_api
			+ "/mobile/portal";
	 ...
	 * @return 表单提交HTML文本
	 */
	public static String BuildFormH5(String seller_email, String merchant_id,
			String notify_url, String return_url, String transtime,
			String currency, String member_id, String member_ip,
			String terminal_type, String terminal_info, String key,
			String sign_type, String order_no, String title, String body,
			String total_fee, String form_url) throws Exception {
		...
		sbHtml.append(
				...
				.append(form_url).append("\" method=\"post\">");

		sbHtml.append("<input type=\"hidden\" name=\"merchant_id\" value=\"")
				.append(merchant_id).append("\"/>");
