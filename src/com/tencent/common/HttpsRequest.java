...
public class HttpsRequest implements IServiceRequest{
    ...
    public void initWithoutCert() throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
...
/*        KeyStore keyStore = KeyStore.getInstance("PKCS12");
    ...
    public String sendPost(String url, Object xmlObj) throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
       ...
       // String d=new String(postDataXML.getBytes(),"ISO-8859-1");
    ...
    public String sendPostWithoutCert(String url, Object xmlObj) throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
