  ...
  <body>
  	 ...
  	 <div align="center">				
			   <table width="50%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" style="padding: 5px; margin-top: 50px;" >
					...
					<tr>
						<td height="40" align="left"><div align="center" class="STYLE4">融宝快捷退款接口</div></td>
					</tr>
					<tr>
						<td height="40"> 
						   <div style=" margin-left:100px">
						   	<form action="cannelCardResult.jsp" method="post" >		        
				                    ...
				                    <TR>                      
				                     ...
				                     <TR>                  
				                      <TD height="40" align="right">原订单号:</TD>
				                      <TD class=form-star>* </TD>
				                      <TD style="padding:5px;"><input type="text" id="orig_order_no" name = "orig_order_no" /></TD>
				                    </TR>
				                      <TR>                  
				                      <TD height="40" align="right">退款金额:</TD>
				                      <TD class=form-star>* </TD>
				                      <TD style="padding:5px;"><input type="text" id="amount" name = "amount" />单位：元</TD>
				                    </TR>	
				                     <TR>                  
				                      <TD height="40" align="right">退款说明:</TD>
				                      <TD class=form-star>* </TD>
				                      <TD style="padding:5px;"><input type="text" id="note" name = "note"  /></TD>
				                    </TR>						                    
				                     <TR>                      
