...
//////////////////////////////////// 请求参数 //////////////////////////////////////
	...
	/* 	String extend_param = request.getParameter("extend_param"); */
		...
		*/
		...
		System.out.println("[多得宝银联支付]接收的param:"+pr);
		logger.info("[多得宝银联支付]接收的param:"+pr);
...
<body onLoad="document.dinpayForm.submit();">
  <form name="dinpayForm" method="post" action="https://pay.ddbill.com/gateway?input_charset=<%=input_charset%>" >
